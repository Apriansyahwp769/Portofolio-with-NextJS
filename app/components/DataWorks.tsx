...
export const data = [
    ...
    {
        id : 3,
        judul : "First Portofolio",
        image : lima,
        desc : "hasil course selama 8 jam memahami penggunaan tailwind yang memungkinkan pembuatan website menjadi lebih cepat dan praktis",
        link : "https://portofolio-apriansyah-wahyudi-putra.vercel.app/",
        source : "...",
        tech : [
          "HTML",
          "Javascript",
    ...
    {
        id : 2,
        judul : "Freelance SI FEST WEBSITE",
        image : dua,
        desc : "membuat web landing page, login, serta pendaftaran yang terintegrasi dengan backend",
        link : "...",
        source : "...",
        tech : [
            "HTML",
    ...
    {
        id : 1,
        judul : "SI FEST WEBSITE",
        image : tiga,
        desc : "membuat web landing page, login, payment gateway yang terintegrasi dengan backend",
